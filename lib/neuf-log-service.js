...
class NEUFLogService {
  ...
  _normalizeTimeBucketFilters(filters) {
    ...
    if (filters.timeBucket != null) {
      result.timeFrom = this.parserService.getTimeBucket(filters.timeBucket);
    ...
    if (result.timeFrom != null) {
      result.timeFrom = this.parserService.getTimeBucket(filters.timeFrom);
    }
    if (result.timeTo != null) {
      result.timeTo = this.parserService.getTimeBucket(filters.timeTo);
    }
